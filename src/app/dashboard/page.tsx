...
export default function DashboardPage() {
    ...
    // Normalize the role to lowercase to prevent capitalization bugs and explicitly check it
    ...
    // ==========================================
    // VIEW 2: STRICTLY PROTECTED ADMIN DASHBOARD
    // ==========================================
    if (userRole === 'admin') {
    ...
    // ==========================================
    // VIEW 3: THE SAFE FALLBACK (Role missing/broken)
    // ==========================================
    return (
        <div className="flex flex-col items-center justify-center min-h-[60vh]">
            <h2 className="text-2xl font-bold text-rose-600 mb-2">Access Error</h2>
            <p className="text-slate-500">Your account role ({user?.role || 'undefined'}) is missing or invalid. Please re-login.</p>
        </div>
    );
}